...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- 해당 제품의 가격이 40000보다 비싸면 버튼이 보여짐 -->\n<p *ngIf=\"product.price > 40000\">\n  <button (click)=\"notify.emit()\">알림</button>\n</p>\n");
...
let CartComponent = class CartComponent {
    constructor(cartService, formBuilder) {
        ...
        //서비스 목록 중 장바구니 목록을 리턴해 주는 메소드를 호출한다.
...
let ProductDetailsComponent = class ProductDetailsComponent {
    ...
    //buy버튼을 누르면 호출되는 메소드
    addToCart(product) {
        window.alert('해당 상품이 장바구니에 담겼습니다.!');
        //실제로 장바구니에 상품을 담기 위해 서비스에서 메소드 호출하기
...
module.exports = __webpack_require__(/*! E:\박태민\08.웹표준코딩실무\05.Angular\store\src\main.ts */"./src/main.ts");
